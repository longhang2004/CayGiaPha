 ...
 * All icons are 24 × 24 viewport, stroke-based, accessible via aria-hidden on
 * the svg element (callers supply aria-label on the surrounding button/link).
 */
...
function icon(paths: React.ReactNode) {
  return function Icon({ size = 20, className, style, ...rest }: IconProps) {
    return (
      <svg
...
/** ⊙ Center / focus the current selection */
...
/** ← Reset / home view */
export const ResetViewIcon = icon(
  <>
