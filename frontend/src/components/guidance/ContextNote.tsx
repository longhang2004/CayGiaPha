...
interface Props { topicId: string; role: GuidanceRole; manual?: boolean; onClose?: () => void; }
export function ContextNote({ topicId, role, manual = false, onClose }: Props) {
