...
export const CORE_CHECKLIST: ChecklistItemDefinition[] = [
  ...
  { id: "core-first-primitive", title: "Nối cha, mẹ, vợ/chồng hoặc con", topicId: "them-nguoi-moi", roles: ["owner", "editor"], eligible: s => s.treeOpened && s.personCount > 0 && s.primitiveCount === 0, complete: s => s.primitiveCount > 0 },
