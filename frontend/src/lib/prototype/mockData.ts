...
export const MOCK_PERSONS: Person[] = [
  ...
  { id: "bac", displayName: "Hàng Hữu Phong", gender: "male", birthOrder: 1, birthYear: 1970, deceased: false },
  { id: "bac-dau", displayName: "Nguyễn Thị Lan", gender: "female", birthYear: 1972, deceased: false },
  { id: "ba", displayName: "Hàng Hữu Phương", gender: "male", birthOrder: 2, birthYear: 1978, deceased: false },
  { id: "ma", displayName: "Phạm Thị Cẩm Tú", gender: "female", birthOrder: 1, birthYear: 1978, deceased: false },
  { id: "co", displayName: "Hàng Hữu Phượng", gender: "female", birthOrder: 3, birthYear: 1980, deceased: false },
  { id: "duong", displayName: "Nguyễn Văn Hùng", gender: "male", birthOrder: 1, birthYear: 1978, deceased: false },
  ...
  { id: "duong-em-gai", displayName: "Nguyễn Thị Hạnh", gender: "female", birthOrder: 2, birthYear: 1985, deceased: false },
  { id: "duong-em-re", displayName: "Trần Văn Khoa", gender: "male", birthYear: 1983, deceased: false },
  { id: "chu", displayName: "Hàng Hữu Phú", gender: "male", birthOrder: 4, birthYear: 1982, deceased: false },
  { id: "thim", displayName: "Trần Thị Hồng", gender: "female", birthYear: 1985, deceased: false },
  { id: "di", displayName: "Phạm Thị Cẩm Linh", gender: "female", birthOrder: 3, birthYear: 1985, deceased: false },
  { id: "cau", displayName: "Phạm Văn Thái", gender: "male", birthOrder: 2, birthYear: 1982, deceased: false },
  ...
  { id: "anh-ruot", displayName: "Hàng Nhựt Tiến", gender: "male", birthOrder: 1, birthYear: 2000, deceased: false },
  { id: "chi-dau", displayName: "Nguyễn Thị Hương", gender: "female", birthYear: 2002, deceased: false },
  { id: "ego", displayName: "Hàng Nhựt Long", gender: "male", birthOrder: 2, birthYear: 2004, deceased: false },
  { id: "vo", displayName: "Nguyễn Thị Minh", gender: "female", birthYear: 2006, deceased: false },
  { id: "em", displayName: "Hàng Phương Ngọc", gender: "female", birthOrder: 3, birthYear: 2012, deceased: false },
...
export const MOCK_RELATIONSHIPS: Relationship[] = [
  ...
  { id: "r-marriage-bac", type: "marriage", sourceId: "bac", targetId: "bac-dau", derivationState: "derived" },
  { id: "r-m-bama", type: "marriage", sourceId: "ba", targetId: "ma", derivationState: "derived" },
  { id: "r-marriage-co", type: "marriage", sourceId: "duong", targetId: "co", derivationState: "derived" },
  { id: "r-m-duong-cha-me", type: "marriage", sourceId: "duong-cha", targetId: "duong-me", derivationState: "derived" },
  { id: "r-marriage-duong-em", type: "marriage", sourceId: "duong-em-re", targetId: "duong-em-gai", derivationState: "derived" },
  { id: "r-marriage-chu", type: "marriage", sourceId: "chu", targetId: "thim", derivationState: "derived" },
  ...
  { id: "r-marriage-anh-ruot", type: "marriage", sourceId: "anh-ruot", targetId: "chi-dau", derivationState: "derived" },
  { id: "r-m-egovo", type: "marriage", sourceId: "ego", targetId: "vo", derivationState: "derived" },
  { id: "r-marriage-em", type: "marriage", sourceId: "em-re", targetId: "em", derivationState: "derived" },
