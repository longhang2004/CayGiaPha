      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 20px; border: 1px solid #e9e9e9; border-radius: 8px;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${safeInviteUrl}" style="background-color: #b43b16; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; display: inline-block;">Tham gia xây dựng cây</a>
          </div>
