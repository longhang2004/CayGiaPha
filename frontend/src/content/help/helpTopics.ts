...
export const HELP_TOPICS: HelpTopic[] = [
  {
    ...
    excerpts: { overview: "Tạo cây mới, nhập mã mời của người thân hoặc mở cây bạn đã có.", checklist: "Chọn + Thêm cây để tạo cây mới, nhập mã mời hoặc mở cây đã có." },
    relatedTopicIds: ["them-nguoi-dau-tien", "moi-va-quan-ly-cong-tac"], reviewedAt: "2026-07-13",
  },
  {
  ...
  },
  {
    ...
    excerpts: {}, relatedTopicIds: ["them-quan-he-ro-rang"], reviewedAt: "2026-07-13",
  },
  {
  ...
  },
  {
    ...
    excerpts: {}, relatedTopicIds: ["bao-mat-va-chia-se-cay"], reviewedAt: "2026-07-13",
  },
  {
