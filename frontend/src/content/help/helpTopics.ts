...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  {
    id: "dieu-huong-so-do", aliases: ["tim-duong-di"], version: 3, status: "active", roles: ALL_ROLES,
    ...
    steps: ["Nhập tên hoặc cách xưng hô vào ô tìm kiếm để chọn nhanh một người.", "Kéo vùng trống để di chuyển; sơ đồ sẽ tự dừng ở giới hạn của cả bốn hướng.", "Dùng nút thu phóng hoặc cuộn chuột; trên màn hình cảm ứng, dùng hai ngón tay. Thu phóng sẽ dừng khi chạm giới hạn."],
