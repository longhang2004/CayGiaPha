...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  {
    id: "sua-va-them-thanh-vien", version: 3, status: "active", roles: ALL_ROLES,
    category: "nguoi-va-quan-he", keywords: ["sửa thông tin", "thêm thành viên", "thêm người", "cập nhật", "cách gọi"],
    ...
    prerequisites: ["Cây có ít nhất một người.", "Trong bảng thông tin, tài khoản của bạn thấy Chỉnh sửa thông tin, Cập nhật quan hệ hoặc Ghi cách gọi."],
    steps: ["Chọn người cần cập nhật.", "Chọn Chỉnh sửa thông tin để sửa hồ sơ, Cập nhật quan hệ để nối cha/mẹ/con/vợ/chồng, hoặc Ghi cách gọi khi chưa biết ông bà trung gian.", "Dùng nút quay lại để về thông tin người đó. Nút X đóng toàn bộ bảng thông tin."],
    ...
    excerpts: { contextual: "Dùng Chỉnh sửa thông tin để sửa hồ sơ. Dùng Cập nhật quan hệ để nối hai thành viên đã có. Dùng Ghi cách gọi khi mới biết tên gọi như bác, chú, cô." },
    relatedTopicIds: ["them-nguoi-moi", "them-quan-he-ro-rang", "ghi-cach-goi-net-dut", "luu-anh-ky-niem"], reviewedAt: "2026-09-19",
  },
  {
    ...
    relatedTopicIds: ["them-nguoi-moi", "ghi-cach-goi-net-dut", "doc-duong-quan-he", "xem-thong-tin-va-xung-ho"], reviewedAt: "2026-07-17",
  },
  {
    id: "ghi-cach-goi-net-dut", version: 1, status: "active", roles: ["owner", "editor"],
    category: "nguoi-va-quan-he", keywords: ["nét đứt", "cách gọi", "bác", "chú", "cô", "khai báo"],
    title: "Ghi cách gọi khi chưa rõ đường nối", summary: "Ghi tên gọi như bác, chú, cô giữa hai người đã có khi chưa biết ông bà trung gian.",
    purpose: "Giữ được điều người cao tuổi nhớ, dù cây chưa đủ người để hệ thống tự tính xưng hô.",
    prerequisites: ["Cây có ít nhất hai người.", "Bạn có quyền cập nhật quan hệ của người đang xem."],
    steps: ["Chọn người sẽ gọi người kia (ví dụ cháu).", "Chọn Ghi cách gọi.", "Chọn người được gọi, nhập cách gọi 1 đến 50 chữ, rồi xác nhận lưu. Đường nét đứt sẽ hiện trên sơ đồ."],
    success: "Hai người được nối bằng đường nét đứt với đúng cách gọi đã ghi.",
    recovery: "Nếu cách gọi trống hoặc quá dài, hệ thống báo lỗi và không lưu. Khi sau này thêm đủ cha/mẹ trung gian, hệ thống đối chiếu cách gọi với xưng hô tính được.",
    excerpts: { contextual: "Ghi cách gọi khi mới biết bác, chú, cô mà chưa vẽ được ông bà ở giữa." },
    relatedTopicIds: ["them-quan-he-ro-rang", "doc-duong-quan-he", "sua-va-them-thanh-vien"], reviewedAt: "2026-09-19",
  },
  {
  ...
  },
  {
    ...
    excerpts: { contextual: "Mở Chú giải sơ đồ để phân biệt quan hệ trực tiếp và tên gọi tự khai báo." }, relatedTopicIds: ["them-quan-he-ro-rang", "ghi-cach-goi-net-dut"], reviewedAt: "2026-07-15",
  },
  {
