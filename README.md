...
* Local Java API: host JAR + Postgres/Redis is the verified path; Docker Compose is documented for hosts that can start containers — see [backend/README.md](backend/README.md)
